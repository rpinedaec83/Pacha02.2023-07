...
alter table ubigeo_distrito add FOREIGN KEY (provincia_id)
references ubigeo_provincia(id);
alter table ubigeo_distrito add FOREIGN KEY (departamento_id)
references ubigeo_departamentos(id);

INSERT INTO ubigeo_distrito (id, descripcion, provincia_id, departamento_id) VALUES
