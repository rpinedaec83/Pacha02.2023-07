...
### TÍTULO: Sistema de Deploy Continuo online
Utilizar Vercel y Azure para deplegar la hackaton anterior

#### EL PROBLEMA: 

Desplegar en Vercel y Azure la Hackaton anterior, como entregable es las URL's de las plataformas
